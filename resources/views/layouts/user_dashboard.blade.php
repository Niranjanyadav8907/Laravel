...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini layout-fixed"> 
		...
		<div class="wrapper"> 
			...
			@include('partials.user_dashboard.preloader') 
			@include('partials.user_dashboard.header') 
			@include('partials.user_dashboard.sidebar') 
			...
			<div class="content-wrapper">
                <div class="content-header content_header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">@yield('page-title', 'User Dashboard')</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">@yield('breadcrumb', 'User Dashboard')</li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            </div> @include('partials.user_dashboard.footer') <aside class="control-sidebar control-sidebar-dark"></aside>
        </div>
        ...
        <!--<script src="{{ asset('AdminLTE/dist/js/pages/dashboard.js') }}"></script>--> @stack('scripts')
    </body>
</html>